...
const ProductSearchResult = () => {
    ...
    useEffect(() => {
        const fetchShowProduct = async () => {
            try {
                const resShowProduct = await axios.get(`https://four-gems-api-c21adc436e90.herokuapp.com/product/show-product?countId=1&pageSize=9&page=0&sortKeyword=productId&sortType=DESC&categoryName=&searchKeyword=`, {
                    headers: {
