...
// Encode the buffer back to base64
        ...
        const productNew = {
            ...
            price: values.laborPrice + values.ratioPrice + values.stonePrice + values.costPrice,
        ...
        try {
            ...
            const response = await axios.post("https://four-gems-api-c21adc436e90.herokuapp.com/product/create-product", productNew,
                    {
                        headers: {
