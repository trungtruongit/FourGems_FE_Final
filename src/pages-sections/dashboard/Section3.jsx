    ...
    const fetchData7 = async () => {
      try {
        ...
        const resTotal7 = await axios.get(
          `https://four-gems-api-c21adc436e90.herokuapp.com/order/get-money-by-date?countId=1&startDate=${startDate7}&endDate=${endDate7}`,
          {
            headers: {
    ...
    const fetchDataEach7 = async () => {
      try {
        ...
        const resEach7 = await axios.get(
          `https://four-gems-api-c21adc436e90.herokuapp.com/order/get-money-each-day?countId=1&startDate=${startDate7}&endDate=${endDate7}`,
          {
            headers: {
              Authorization: "Bearer " + token, //the token is a variable which holds the token
            },
    ...
    const fetchOrder7 = async () => {
      try {
        ...
        const resOrder7 = await axios.get(
          `https://four-gems-api-c21adc436e90.herokuapp.com/order/get-number-order-by-date?countId=1&startDate=${startDate7}&endDate=${endDate7}`,
          {
            headers: {
              Authorization: "Bearer " + token, //the token is a variable which holds the token
            },
    ...
    const fetchEachDayOrder7 = async () => {
      try {
        ...
        const resEachDayOrder7 = await axios.get(
          `https://four-gems-api-c21adc436e90.herokuapp.com/order/get-total-order-each-day?countId=1&startDate=${startDate7}&endDate=${endDate7}`,
          {
            headers: {
              Authorization: "Bearer " + token, //the token is a variable which holds the token
            },
